<template>
  <f7-page
    ...
    @infinite="loadMore"
  >
    <f7-navbar title="Order List" back-link="Back">
      <div class="right">
        <f7-link
          href="/"
      ...
      <ul>
        ...
        >
          ...
          <f7-swipeout-actions right>
            ...
            >
            <f7-swipeout-button  color="blue" href="/current-stock/" view=".view-main" panel-close @click="dueCollection"
...
export default {
  ...
  methods: {
    ...
    dueCollection() {
      f7.dialog.alert("It's Due-collection!");
    },
    print() {
